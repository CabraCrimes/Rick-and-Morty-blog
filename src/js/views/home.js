...
export const Home = () => {
	...
	return (
		<div className=" bg-info">
			<div className="container bg-dark d-flex mx-auto row text-center pt-4 rounded ">
				
				{/* Character*/}
				<Link to="/characters">
					<h2 className="btn text-info fs-3">Characters</h2>
				</Link>
				...
				{/* Location */}
				<Link to="/location">
					<h2 className="btn text-info fs-3">Locations</h2>
				</Link>
				<div className="d-flex overflow-auto mb-5">
				...
				{/* Episodes */}
				<Link to="/episodes">
					<h2 className="btn text-info fs-3">Episode</h2>
				</Link>
				<div className="d-flex overflow-auto mb-5">
